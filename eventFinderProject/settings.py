...
DATABASES = {
    'default': {
        ...
        'NAME': 'database_main', #07/09/2019 Eleanor  # you will need to create this db
        'USER': 'postgres', #07/09/2019 Eleanor # enter your user name here
        'PASSWORD': 'postgres',#07/09/2019 Eleanor
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
